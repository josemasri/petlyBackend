export default class Animal {
    ...
    constructor($nombre: string, $estructuraVertebral: string, $tipoReproduccion: string, $medioDeVida: string, $habitosNaturales: string, $excresion: string, $sexo: string, $dieta: string, $edad: number, $img: string) {
        this.nombre = $nombre;
